...
extract_facility_receptors_from_plume <- function(parsed_plume, facilities, cfg, write_outputs = FALSE,
    overwrite = FALSE, refresh_run_index = TRUE) {
  ...
  if (isTRUE(write_outputs)) {
    extracted$extraction_metadata <- write_facility_receptor_outputs(extracted, meta$run_directory, overwrite)
