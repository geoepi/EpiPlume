...
## Closing  
This script simualted a pathogen plume from a source farm location followed secondary outbreaks at other farms downwind.  Next, the results here are analysed in the [script linked here](https://geoepi.github.io/EpiPlume/trace_emission_source.html) to determine if that outbreak can be traced back to the orginal source farm.
```
