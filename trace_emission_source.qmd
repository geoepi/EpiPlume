...
## Trajectory Models
A [HYSPLIT](https://www.ready.noaa.gov/HYSPLIT.php) model is constructed assuming the secondary outbreak location was a *receptor* of the plume from an unknown source.  The [**splitR** package](https://github.com/rich-iannone/splitr) is used to call a HYSPLIT exceutable from R.
